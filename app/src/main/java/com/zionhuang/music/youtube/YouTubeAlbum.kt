...
suspend fun YouTube.getAlbumWithSongs(context: Context, browseId: String, playlistId: String? = null): AlbumWithSongs {
    ...
    val songIds = browse(BrowseEndpoint(browseId = "VL${playlistId ?: header.id}")).getOrThrow()
        .items
