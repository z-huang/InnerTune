...
object SongSortInfoPreference : IMutableSortInfo<SongSortType> {
    val context: Context get() = getApplication()
    override var type: SongSortType by enumPreference(context, R.string.pref_song_sort_type, SongSortType.CREATE_DATE)
    override var isDescending by Preference(context, R.string.pref_song_sort_descending, true)
    private val typeFlow = context.sharedPreferences.enumFlow(context.getString(R.string.pref_song_sort_type), SongSortType.CREATE_DATE)
    private val isDescendingFlow = context.sharedPreferences.booleanFlow(context.getString(R.string.pref_song_sort_descending), true)
