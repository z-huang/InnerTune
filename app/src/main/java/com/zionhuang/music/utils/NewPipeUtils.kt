...
fun getPreferredLocalization(context: Context): Localization {
    ...
    return PreferenceStore.getInstance(context).get(context.getString(R.string.pref_content_language), systemDefault).let {
...
fun getPreferredContentCountry(context: Context): ContentCountry {
    val systemDefault = context.getString(R.string.default_localization_key)
    return PreferenceStore.getInstance(context).get(context.getString(R.string.pref_content_country), systemDefault).let {
