...
public class YoutubeInfoExtractor {
    ...
    private final HashMap<String, SignatureFunction> playerCache = new HashMap<>();
    ...
    private ExtractedInfo realExtract(String videoId) {
        ExtractedInfo res = new ExtractedInfo(videoId);
        SongEntity song = new SongEntity(videoId);
        ...
        song.setArtist(channel);
        song.setDuration(videoDuration);
        res.setSong(song);
