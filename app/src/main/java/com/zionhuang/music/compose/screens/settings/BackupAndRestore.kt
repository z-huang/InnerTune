...
import com.zionhuang.music.ui.fragments.settings.BackupRestoreSettingsFragment
import java.io.File
            ...
            context.applicationContext.contentResolver.openOutputStream(uri)?.use {
                it.buffered().zipOutputStream().use { outputStream ->
                    File(
                        ...
                        outputStream.putNextEntry(ZipEntry(BackupRestoreSettingsFragment.PREF_NAME))
